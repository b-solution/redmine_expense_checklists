...
Redmine.ExpenseChecklist = $.klass({
  ...
  onExpenseFormSubmitRemoveEmptyChecklistItems: function() {
    $('body').on('submit', '#expense_form', function(){
  ...
  init: function(element) {
    ...
    this.onExpenseFormSubmitRemoveEmptyChecklistItems()
...
$.fn.expense_checklist = function(element){
  new Redmine.ExpenseChecklist(this);
};

Redmine.ExpenseChecklistToggle = $.klass({
